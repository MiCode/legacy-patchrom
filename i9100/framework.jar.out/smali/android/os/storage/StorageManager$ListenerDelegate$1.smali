...
.method public handleMessage(Landroid/os/Message;)V
    ...
    check-cast v0, Landroid/os/storage/StorageManager$UsbStorageStateChangedStorageEvent;

    move-object v2, v0

    .line 292
    .local v2, ev:Landroid/os/storage/StorageManager$UsbStorageStateChangedStorageEvent;
    iget-object v3, p0, Landroid/os/storage/StorageManager$ListenerDelegate$1;->this$1:Landroid/os/storage/StorageManager$ListenerDelegate;

    iget-object v3, v3, Landroid/os/storage/StorageManager$ListenerDelegate;->mStorageEventListener:Landroid/os/storage/StorageEventListener;

    iget-object v4, v2, Landroid/os/storage/StorageManager$UsbStorageStateChangedStorageEvent;->path:Ljava/lang/String;

    iget-object v5, v2, Landroid/os/storage/StorageManager$UsbStorageStateChangedStorageEvent;->oldState:Ljava/lang/String;

    iget-object v6, v2, Landroid/os/storage/StorageManager$UsbStorageStateChangedStorageEvent;->newState:Ljava/lang/String;

    invoke-virtual {v3, v4, v5, v6}, Landroid/os/storage/StorageEventListener;->onUsbStorageStateChanged(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_0

    .line 294
    .end local v2           #ev:Landroid/os/storage/StorageManager$UsbStorageStateChangedStorageEvent;
    :cond_2
