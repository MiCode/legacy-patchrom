...
.field private mCmdReceiver:Lcom/motorola/android/os/MediaCmdReceiver;
...
.method public constructor <init>()V
    ...
    const-string v1, "ro.mot.deep.sleep.supported"
    ...
    iput-boolean v1, p0, Landroid/media/MediaPlayer;->isDeepSleepSupported:Z
    ...
    iget-boolean v1, p0, Landroid/media/MediaPlayer;->isDeepSleepSupported:Z

    if-eqz v1, :cond_0

    new-instance v1, Lcom/motorola/android/os/MediaCmdReceiver;

    invoke-direct {v1, p0}, Lcom/motorola/android/os/MediaCmdReceiver;-><init>(Landroid/media/MediaPlayer;)V

    iput-object v1, p0, Landroid/media/MediaPlayer;->mCmdReceiver:Lcom/motorola/android/os/MediaCmdReceiver;

    iget-object v1, p0, Landroid/media/MediaPlayer;->mCmdReceiver:Lcom/motorola/android/os/MediaCmdReceiver;

    invoke-virtual {v1}, Lcom/motorola/android/os/MediaCmdReceiver;->init()Z

    iget-object v1, p0, Landroid/media/MediaPlayer;->mCmdReceiver:Lcom/motorola/android/os/MediaCmdReceiver;

    invoke-virtual {v1}, Lcom/motorola/android/os/MediaCmdReceiver;->start()V
...
.method public release()V
    ...
    iget-boolean v0, p0, Landroid/media/MediaPlayer;->isDeepSleepSupported:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/media/MediaPlayer;->mCmdReceiver:Lcom/motorola/android/os/MediaCmdReceiver;

    invoke-virtual {v0}, Lcom/motorola/android/os/MediaCmdReceiver;->isRunning()Z
    ...
    invoke-virtual {v0}, Lcom/motorola/android/os/MediaCmdReceiver;->shutdown()V
...
.method public setDataSource(Landroid/content/Context;Landroid/net/Uri;Ljava/util/Map;)V
    ...
    const-string v1, "Ingore null pointer exception"
