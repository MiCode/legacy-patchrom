...
.field public static final TYPE_RINGTONE_HOME:I = 0x8

.field public static final TYPE_RINGTONE_ROAM:I = 0x10
...
.method private getDrmRingtones()Landroid/database/Cursor;
    ...
    .local v12, externalDrmCursor:Landroid/database/Cursor;
    :goto_0
    sget-object v7, Landroid/provider/DrmStore$Audio;->CONTENT_URI:Landroid/net/Uri;

    sget-object v8, Landroid/media/RingtoneManager;->DRM_COLUMNS:[Ljava/lang/String;
    ...
    invoke-direct/range {v6 .. v11}, Landroid/media/RingtoneManager;->query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;

    move-result-object v13

    .local v13, internalDrmCursor:Landroid/database/Cursor;
    ...
    invoke-direct {v0, v1, v5}, Lcom/android/internal/database/SortCursor;-><init>([Landroid/database/Cursor;Ljava/lang/String;)V

    return-object v0

    .end local v12           #externalDrmCursor:Landroid/database/Cursor;
    .end local v13           #internalDrmCursor:Landroid/database/Cursor;
    :cond_1
    move-object v12, v4
...
.method private static getRingtone(Landroid/content/Context;Landroid/net/Uri;I)Landroid/media/Ringtone;
    ...
    invoke-virtual {v2, v3}, Landroid/media/Ringtone;->open(Landroid/net/Uri;)V
    :try_end_1
    ...
    const-string v4, "Failed to open default ringtone "
