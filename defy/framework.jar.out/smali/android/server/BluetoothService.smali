...
.field private static final DISCOVERABLE_ENDTIMESTAMP:Ljava/lang/String; = "bluetooth_discoverable_endtimestamp"
...
.field private static final LOG_EVENT_BT_TAG:I = 0xf42ae
...
.field private static final UUID_INTENT_DELAY:I = 0x1f40

.field private static mDockAddress:Ljava/lang/String;


# instance fields
.field private discoverableTime:J
...
.field private mBtOnPendingRequest:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v3, p0, Landroid/server/BluetoothService;->mAirplaneModeOverwridden:Z

    iput-boolean v3, p0, Landroid/server/BluetoothService;->mRestart:Z

    const-wide/16 v1, 0x0

    iput-wide v1, p0, Landroid/server/BluetoothService;->discoverableTime:J

    const/16 v1, 0x78

    iput v1, p0, Landroid/server/BluetoothService;->mDiscoverableTimeout:I

    iput-boolean v3, p0, Landroid/server/BluetoothService;->mBootCompleted:Z

    iput-boolean v3, p0, Landroid/server/BluetoothService;->mBtOnPendingRequest:Z
...
.method static synthetic access$2502(Landroid/server/BluetoothService;Z)Z
    .locals 0
    .parameter "x0"
    .parameter "x1"

    .prologue
    iput-boolean p1, p0, Landroid/server/BluetoothService;->mAirplaneModeOverwridden:Z
...
.method static synthetic access$2702(Landroid/server/BluetoothService;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2802(Landroid/server/BluetoothService;Z)Z
    .locals 0
    .parameter "x0"
    .parameter "x1"

    .prologue
    iput-boolean p1, p0, Landroid/server/BluetoothService;->mBootCompleted:Z
...
.method static synthetic access$2900(Landroid/server/BluetoothService;)Z
    ...
    .prologue
    iget-boolean v0, p0, Landroid/server/BluetoothService;->mBtOnPendingRequest:Z

    return v0
.end method

.method static synthetic access$2902(Landroid/server/BluetoothService;Z)Z
    .locals 0
    .parameter "x0"
    .parameter "x1"

    .prologue
    iput-boolean p1, p0, Landroid/server/BluetoothService;->mBtOnPendingRequest:Z
...
.method public declared-synchronized cancelBondProcess(Ljava/lang/String;)Z
    ...
    new-instance v1, Landroid/bluetooth/BluetoothHid;

    iget-object v2, p0, Landroid/server/BluetoothService;->mContext:Landroid/content/Context;

    invoke-direct {v1, v2}, Landroid/bluetooth/BluetoothHid;-><init>(Landroid/content/Context;)V

    .local v1, hid:Landroid/bluetooth/BluetoothHid;
    ...
    invoke-virtual {v1, v0}, Landroid/bluetooth/BluetoothHid;->getHidState(Landroid/bluetooth/BluetoothDevice;)I
    ...
    invoke-virtual {v2, p1, v3, v4}, Landroid/server/BluetoothService$BondState;->setBondState(Ljava/lang/String;II)V
    ...
    .end local v1           #hid:Landroid/bluetooth/BluetoothHid;
    :catchall_0
    move-exception v2
...
.method public declared-synchronized enable(Z)Z
    ...
    :try_start_0
    iget-boolean v0, p0, Landroid/server/BluetoothService;->mBootCompleted:Z

    if-ne v0, v4, :cond_5

    const-string v0, "Bootcompleted so turning on Bluetooth"
    ...
    :goto_0
    iput-boolean v0, p0, Landroid/server/BluetoothService;->mAirplaneModeOverwridden:Z
    ...
    iget-boolean v0, p0, Landroid/server/BluetoothService;->mAirplaneModeOverwridden:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_5
    const-string v0, "Boot is not completed, making it as pending request"

    invoke-static {v0}, Landroid/server/BluetoothService;->log(Ljava/lang/String;)V

    const/4 v0, 0x1

    iput-boolean v0, p0, Landroid/server/BluetoothService;->mBtOnPendingRequest:Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized getDiscoverableTime()J
    .locals 4
    ...
    const-string v2, "discoverableTime== "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-wide v2, p0, Landroid/server/BluetoothService;->discoverableTime:J
    ...
    iget-wide v0, p0, Landroid/server/BluetoothService;->discoverableTime:J
...
.method public getFormatsFromCache(Ljava/lang/String;)Ljava/lang/String;
    .locals 5
    .parameter "address"
    ...
    const-string v1, "Remote device does not send support format list attr its mandatory for OPP"
    ...
    const-string v2, "getFormatsFromCache value = "
...
.method removeRemoteDeviceProperties(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Landroid/server/BluetoothService;->mDeviceServiceChannelCache:Ljava/util/HashMap;
...
.method public declared-synchronized setDiscoverableTimeout(I)Z
    ...
    iput p1, p0, Landroid/server/BluetoothService;->mDiscoverableTimeout:I
...
.method public declared-synchronized setScanMode(II)Z
    ...
    iget v7, p0, Landroid/server/BluetoothService;->mDiscoverableTimeout:I
    ...
    iget v5, p0, Landroid/server/BluetoothService;->mDiscoverableTimeout:I
    ...
    iput-wide v5, p0, Landroid/server/BluetoothService;->discoverableTime:J
...
.method public declared-synchronized startDiscovery()Z
    ...
    const-string v6, "mDeviceProperties size is "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-object v6, p0, Landroid/server/BluetoothService;->mDeviceProperties:Ljava/util/HashMap;
    ...
    iget-object v6, p0, Landroid/server/BluetoothService;->mDeviceServiceChannelCache:Ljava/util/HashMap;
    ...
    iget-object v5, p0, Landroid/server/BluetoothService;->mDeviceProperties:Ljava/util/HashMap;
    ...
    const-string v5, "trying to delete object"
    ...
    iget-object v5, p0, Landroid/server/BluetoothService;->mBondState:Landroid/server/BluetoothService$BondState;

    aget-object v6, v0, v4

    invoke-virtual {v5, v6}, Landroid/server/BluetoothService$BondState;->getBondState(Ljava/lang/String;)I
    ...
    const-string v6, "Deleting object"
    ...
    iget-object v5, p0, Landroid/server/BluetoothService;->mDeviceServiceChannelCache:Ljava/util/HashMap;
