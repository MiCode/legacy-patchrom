...
.field private static final LOG_EVENT_BT_MODE_TAG:I = 0xf42af

.field private static final TAG:Ljava/lang/String; = "BluetoothEventLoop"


# instance fields
.field private final action_pairInfo:Ljava/lang/String;
...
.field private mExceptionDB:Ljava/util/HashMap;
...
.field private mRejAddress:Ljava/lang/String;
...
.method constructor <init>(Landroid/content/Context;Landroid/bluetooth/BluetoothAdapter;Landroid/server/BluetoothService;)V
    ...
    const-string v0, "android.bluetooth.device.action.PAIRING_REQUEST_INFO"

    iput-object v0, p0, Landroid/server/BluetoothEventLoop;->action_pairInfo:Ljava/lang/String;

    const/4 v0, 0x0

    iput-object v0, p0, Landroid/server/BluetoothEventLoop;->mRejAddress:Ljava/lang/String;
    ...
    iput-object v0, p0, Landroid/server/BluetoothEventLoop;->mExceptionDB:Ljava/util/HashMap;
    ...
    invoke-direct {p0}, Landroid/server/BluetoothEventLoop;->loadExceptionDB()V
...
.method private loadExceptionDB()V
    .locals 3

    .prologue
    const-string v0, "BluetoothEventLoop"

    const-string v1, "enter loadExceptionDB"

    invoke-static {v0, v1}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v0, p0, Landroid/server/BluetoothEventLoop;->mExceptionDB:Ljava/util/HashMap;

    const-string v1, "Motorola IHF1000"
...
.method private onAgentAuthorize(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    iget-object v0, v0, Landroid/server/BluetoothEventLoop;->mBluetoothService:Landroid/server/BluetoothService;
    ...
    .local v11, sink_size:I
    if-nez v3, :cond_0

    const-string v13, "BluetoothEventLoop"

    const-string v14, "Unable to get device address in onAuthAgentAuthorize"
    ...
    .local v4, authorized:Z
    invoke-static/range {p2 .. p2}, Landroid/os/ParcelUuid;->fromString(Ljava/lang/String;)Landroid/os/ParcelUuid;
    ...
    iget-object v0, v0, Landroid/server/BluetoothEventLoop;->mContext:Landroid/content/Context;

    move-object v13, v0

    invoke-direct {v2, v13}, Landroid/bluetooth/BluetoothA2dp;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v2}, Landroid/bluetooth/BluetoothA2dp;->getNonDisconnectedSinks()Ljava/util/Set;
    ...
    .local v6, devices:Ljava/util/Set;,"Ljava/util/Set<Landroid/bluetooth/BluetoothDevice;>;"
    ...
    .end local v6           #devices:Ljava/util/Set;,"Ljava/util/Set<Landroid/bluetooth/BluetoothDevice;>;"
    ...
    invoke-static {v12}, Landroid/bluetooth/BluetoothUuid;->isAudioSource(Landroid/os/ParcelUuid;)Z

    move-result v13

    if-nez v13, :cond_3

    invoke-static {v12}, Landroid/bluetooth/BluetoothUuid;->isAvrcpTarget(Landroid/os/ParcelUuid;)Z

    move-result v13

    if-nez v13, :cond_3

    invoke-static {v12}, Landroid/bluetooth/BluetoothUuid;->isAdvAudioDist(Landroid/os/ParcelUuid;)Z
    ...
    invoke-direct {v0, v1}, Landroid/server/BluetoothEventLoop;->isOtherSinkInNonDisconnectingState(Ljava/lang/String;)Z
    ...
    iget-object v0, v0, Landroid/server/BluetoothEventLoop;->mAdapter:Landroid/bluetooth/BluetoothAdapter;

    move-object v13, v0

    invoke-virtual {v13, v3}, Landroid/bluetooth/BluetoothAdapter;->getRemoteDevice(Ljava/lang/String;)Landroid/bluetooth/BluetoothDevice;

    move-result-object v5

    .restart local v5       #device:Landroid/bluetooth/BluetoothDevice;
    invoke-virtual {v2, v5}, Landroid/bluetooth/BluetoothA2dp;->getSinkPriority(Landroid/bluetooth/BluetoothDevice;)I
    ...
    const-string v15, "Allowing incoming A2DP / AVRCP connection from "
    ...
    invoke-virtual {v13, v3}, Landroid/server/BluetoothService;->notifyIncomingA2dpConnection(Ljava/lang/String;)Z
    ...
    const-string v14, "onAgentAuthorize("
    ...
    const-string v15, "Rejecting incoming A2DP / AVRCP connection from "
    ...
    invoke-static {v12}, Landroid/bluetooth/BluetoothUuid;->isHidDevice(Landroid/os/ParcelUuid;)Z

    move-result v13

    if-eqz v13, :cond_a

    new-instance v7, Landroid/bluetooth/BluetoothHid;
    ...
    invoke-direct {v7, v13}, Landroid/bluetooth/BluetoothHid;-><init>(Landroid/content/Context;)V

    .local v7, hid:Landroid/bluetooth/BluetoothHid;
    move-object/from16 v0, p0
    ...
    .restart local v5       #device:Landroid/bluetooth/BluetoothDevice;
    invoke-virtual {v7, v5}, Landroid/bluetooth/BluetoothHid;->getHidPriority(Landroid/bluetooth/BluetoothDevice;)I
    ...
    const-string v15, "Allowing incoming HID connection from "
    ...
    const-string v13, "android.bluetooth.device.action.PAIRING_REQUEST_INFO"

    invoke-direct {v10, v13}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .local v10, o:Landroid/content/Intent;
    ...
    invoke-virtual {v10, v13, v9}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    ...
    const-string v15, "Rejecting incoming HID connection from And Posting intent"
    ...
    .end local v5           #device:Landroid/bluetooth/BluetoothDevice;
    .end local v7           #hid:Landroid/bluetooth/BluetoothHid;
    .end local v9           #name:Ljava/lang/String;
    .end local v10           #o:Landroid/content/Intent;
    :cond_a
    const-string v13, "BluetoothEventLoop"
    ...
    const-string v15, "Rejecting incoming "
    ...
    const-string v15, " connection from "
...
.method private onAgentCancel()V
    ...
    iget-object v2, p0, Landroid/server/BluetoothEventLoop;->mRejAddress:Ljava/lang/String;
    ...
    .local v1, pendingOutgoingAddress:Ljava/lang/String;
    iget-object v2, p0, Landroid/server/BluetoothEventLoop;->mBluetoothService:Landroid/server/BluetoothService;

    invoke-virtual {v2}, Landroid/server/BluetoothService;->getScanMode()I
...
.method private onDevicePropertyChanged(Ljava/lang/String;[Ljava/lang/String;)V
    ...
    invoke-virtual {v9, v0, v6, v2}, Landroid/server/BluetoothService;->setRemoteDeviceProperty(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private onRequestPairingConsent(Ljava/lang/String;I)V
    ...
    invoke-virtual {v4}, Landroid/server/BluetoothService;->getScanMode()I
    ...
    invoke-virtual {v4, v0}, Landroid/server/BluetoothService;->cancelPairingUserInput(Ljava/lang/String;)Z
...
.method private onRequestPasskeyConfirmation(Ljava/lang/String;II)V
    ...
    const-string v7, "onRequestPasskeyConfirmation - Enter"
    ...
    .local v6, pendingOutgoingAddressHid:Ljava/lang/String;
    invoke-direct {p0, p1, p3}, Landroid/server/BluetoothEventLoop;->checkPairingRequestAndGetAddress(Ljava/lang/String;I)Ljava/lang/String;
    ...
    .local v2, deviceHid:Landroid/bluetooth/BluetoothDevice;
    ...
    .local v1, btClassHid:Landroid/bluetooth/BluetoothClass;
    ...
    const-string v7, "Incoming HID connection and remote device is HID device"
    ...
    .local v5, oHid:Landroid/content/Intent;
    invoke-virtual {v2}, Landroid/bluetooth/BluetoothDevice;->getName()Ljava/lang/String;

    move-result-object v4

    .local v4, nameHid:Ljava/lang/String;
    ...
    const-string v7, "sent action_pairInfo intent"

    invoke-static {v9, v7}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    goto :goto_0

    .end local v4           #nameHid:Ljava/lang/String;
    .end local v5           #oHid:Landroid/content/Intent;
    :cond_2
    const-string v7, "BluetoothEventLoop"

    const-string v7, "It is Outgoing connection and remote device is not an HID device"
...
.method private onRequestPinCode(Ljava/lang/String;I)V
    ...
    invoke-virtual {v9}, Landroid/server/BluetoothService;->getDockPin()Ljava/lang/String;
    ...
    invoke-virtual {v9, v0, v10}, Landroid/server/BluetoothService;->setPin(Ljava/lang/String;[B)Z
    ...
    invoke-virtual {v9, v0, v10}, Landroid/server/BluetoothService;->getRemoteDeviceProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v9, p0, Landroid/server/BluetoothEventLoop;->mExceptionDB:Ljava/util/HashMap;
    ...
    .local v8, pincode:Ljava/lang/String;
    iget-object v9, p0, Landroid/server/BluetoothEventLoop;->mBluetoothService:Landroid/server/BluetoothService;
    ...
    invoke-virtual {v9, v0}, Landroid/server/BluetoothService$BondState;->hasAutoPairingFailed(Ljava/lang/String;)Z
    ...
    invoke-virtual {v9, v0}, Landroid/server/BluetoothService$BondState;->attempt(Ljava/lang/String;)V
    ...
    .end local v8           #pincode:Ljava/lang/String;
    :cond_2
    new-instance v1, Landroid/bluetooth/BluetoothClass;

    iget-object v9, p0, Landroid/server/BluetoothEventLoop;->mBluetoothService:Landroid/server/BluetoothService;

    invoke-virtual {v9, v0}, Landroid/server/BluetoothService;->getRemoteClass(Ljava/lang/String;)I

    move-result v9

    invoke-direct {v1, v9}, Landroid/bluetooth/BluetoothClass;-><init>(I)V
    ...
    :cond_3
    new-instance v3, Landroid/bluetooth/BluetoothHid;

    iget-object v9, p0, Landroid/server/BluetoothEventLoop;->mContext:Landroid/content/Context;

    invoke-direct {v3, v9}, Landroid/bluetooth/BluetoothHid;-><init>(Landroid/content/Context;)V

    .local v3, hid:Landroid/bluetooth/BluetoothHid;
    iget-object v9, p0, Landroid/server/BluetoothEventLoop;->mAdapter:Landroid/bluetooth/BluetoothAdapter;
    ...
    invoke-virtual {v3, v2}, Landroid/bluetooth/BluetoothHid;->getHidState(Landroid/bluetooth/BluetoothDevice;)I
    ...
    invoke-virtual {v3, v2}, Landroid/bluetooth/BluetoothHid;->getHidPriority(Landroid/bluetooth/BluetoothDevice;)I
    ...
    .end local v3           #hid:Landroid/bluetooth/BluetoothHid;
    .restart local v1       #btClass:Landroid/bluetooth/BluetoothClass;
    .restart local v5       #name:Ljava/lang/String;
    :sswitch_0
    iget-object v9, p0, Landroid/server/BluetoothEventLoop;->mBluetoothService:Landroid/server/BluetoothService;

    invoke-virtual {v9, v0}, Landroid/server/BluetoothService;->attemptAutoPair(Ljava/lang/String;)Z
    ...
    .restart local v3       #hid:Landroid/bluetooth/BluetoothHid;
    :cond_4
    new-instance v4, Landroid/content/Intent;
