...
.field static final TRANSACTION_addHostRouteByInterface:I = 0x1f

.field static final TRANSACTION_configureNetwork:I = 0x1a

.field static final TRANSACTION_getActiveNetworkInfo:I = 0x3

.field static final TRANSACTION_getAllNetworkInfo:I = 0x5

.field static final TRANSACTION_getAllNetworkInfoOem:I = 0x1b

.field static final TRANSACTION_getBackgroundDataSetting:I = 0xc

.field static final TRANSACTION_getLastTetherError:I = 0x13

.field static final TRANSACTION_getMobileDataEnabled:I = 0xe

.field static final TRANSACTION_getNetworkInfo:I = 0x4

.field static final TRANSACTION_getNetworkInfoOem:I = 0x1c

.field static final TRANSACTION_getNetworkInterface:I = 0x1d
...
.field static final TRANSACTION_isTetheringSupported:I = 0x14

.field static final TRANSACTION_rawIptablesCommand:I = 0x10

.field static final TRANSACTION_removeHostRoutes:I = 0x1e

.field static final TRANSACTION_removeHostRoutesByInterface:I = 0x20
...
.field static final TRANSACTION_tether:I = 0x11

.field static final TRANSACTION_untether:I = 0x12
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .local v2, _arg2:I
    invoke-virtual {p0, v0, v1, v2}, Landroid/net/IConnectivityManager$Stub;->requestRouteToHostAddress(I[BI)Z
    ...
    invoke-virtual {p0, v0}, Landroid/net/IConnectivityManager$Stub;->rawIptablesCommand(Ljava/lang/String;)Z
    ...
    .local v1, _arg1:[Ljava/lang/String;
    invoke-virtual {p0, v0, v1}, Landroid/net/IConnectivityManager$Stub;->configureNetwork(I[Ljava/lang/String;)Z
    ...
    invoke-virtual {p0}, Landroid/net/IConnectivityManager$Stub;->getAllNetworkInfoOem()[Landroid/net/NetworkInfoOem;

    move-result-object v3

    .local v3, _result:[Landroid/net/NetworkInfoOem;
    invoke-virtual {p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v3           #_result:[Landroid/net/NetworkInfoOem;
    :sswitch_1c
    const-string v4, "android.net.IConnectivityManager"
    ...
    .local v0, _arg0:Ljava/lang/String;
    invoke-virtual {p0, v0}, Landroid/net/IConnectivityManager$Stub;->getNetworkInfoOem(Ljava/lang/String;)Landroid/net/NetworkInfoOem;
    ...
    invoke-virtual {v3, p3, v5}, Landroid/net/NetworkInfoOem;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    .local v0, _arg0:I
    invoke-virtual {p0, v0}, Landroid/net/IConnectivityManager$Stub;->getNetworkInterface(I)Ljava/lang/String;
    ...
    .restart local v0       #_arg0:I
    invoke-virtual {p0, v0}, Landroid/net/IConnectivityManager$Stub;->removeHostRoutes(I)Z
    ...
    .local v1, _arg1:I
    invoke-virtual {p0, v0, v1}, Landroid/net/IConnectivityManager$Stub;->addHostRouteByInterface(Ljava/lang/String;I)Z
    ...
    .restart local v0       #_arg0:Ljava/lang/String;
    invoke-virtual {p0, v0}, Landroid/net/IConnectivityManager$Stub;->removeHostRoutesByInterface(Ljava/lang/String;)Z
