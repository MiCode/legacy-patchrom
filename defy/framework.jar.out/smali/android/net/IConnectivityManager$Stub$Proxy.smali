...
.method public getAllNetworkInfoOem()[Landroid/net/NetworkInfoOem;
    ...
    sget-object v3, Landroid/net/NetworkInfoOem;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, v3}, Landroid/os/Parcel;->createTypedArray(Landroid/os/Parcelable$Creator;)[Ljava/lang/Object;

    move-result-object v2

    check-cast v2, [Landroid/net/NetworkInfoOem;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .local v2, _result:[Landroid/net/NetworkInfoOem;
    invoke-virtual {v1}, Landroid/os/Parcel;->recycle()V
    ...
    .end local v2           #_result:[Landroid/net/NetworkInfoOem;
    :catchall_0
    move-exception v3
...
.method public getNetworkInfoOem(Ljava/lang/String;)Landroid/net/NetworkInfoOem;
    ...
    .restart local v2       #_result:Landroid/net/NetworkInfoOem;
    goto :goto_0
