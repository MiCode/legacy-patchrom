...
.method private parseERecordTwo(II)V
    ...
    iget-object v2, p0, Landroid/telephony/cdma/CmasParser;->cmas:Landroid/telephony/CmasMessage;

    iput v1, v2, Landroid/telephony/CmasMessage;->cmaeIdentifier:I

    iget-object v2, p0, Landroid/telephony/cdma/CmasParser;->cmas:Landroid/telephony/CmasMessage;

    iget-object v3, p0, Landroid/telephony/cdma/CmasParser;->uData:[B
...
.method private parseERecordZero(II)V
    ...
    iput-object v11, v8, Landroid/telephony/CmasMessage;->cmaeAlertText:Ljava/lang/String;
...
.method public parseBroadcastSms(Landroid/telephony/SmsMessage;)Landroid/telephony/CmasMessage;
    ...
    iput-object v7, p0, Landroid/telephony/cdma/CmasParser;->cmas:Landroid/telephony/CmasMessage;
    ...
    iget-object v7, p0, Landroid/telephony/cdma/CmasParser;->cmas:Landroid/telephony/CmasMessage;
    ...
    iput-object v7, p0, Landroid/telephony/cdma/CmasParser;->uData:[B
    ...
    invoke-direct {p0, v5, v0}, Landroid/telephony/cdma/CmasParser;->parseERecordZero(II)V
    ...
    invoke-direct {p0, v5, v0}, Landroid/telephony/cdma/CmasParser;->parseERecordOne(II)V
    ...
    invoke-direct {p0, v5, v0}, Landroid/telephony/cdma/CmasParser;->parseERecordTwo(II)V
