...
.method static createCacheFile(Ljava/lang/String;ILandroid/net/http/Headers;Ljava/lang/String;JZ)Landroid/webkit/CacheManager$CacheResult;
    ...
    invoke-virtual {v3}, Landroid/webkit/CacheManager$CacheResult;->closeOutputStream()Z
...
.method static getCacheFile(Ljava/lang/String;JLjava/util/Map;)Landroid/webkit/CacheManager$CacheResult;
    ...
    invoke-virtual {v2}, Landroid/webkit/CacheManager$CacheResult;->closeInputStream()Z
...
.method static saveCacheFile(Ljava/lang/String;JLandroid/webkit/CacheManager$CacheResult;)V
    ...
    invoke-virtual {p3}, Landroid/webkit/CacheManager$CacheResult;->closeOutputStream()Z
    ...
    :cond_1
    iget-object v1, p3, Landroid/webkit/CacheManager$CacheResult;->outFile:Ljava/io/File;
    ...
    iget v1, p3, Landroid/webkit/CacheManager$CacheResult;->httpStatusCode:I
    ...
    iput-object v1, p3, Landroid/webkit/CacheManager$CacheResult;->localPath:Ljava/lang/String;

    :cond_2
    if-nez v0, :cond_3

    iget-wide v1, p3, Landroid/webkit/CacheManager$CacheResult;->contentLength:J
    ...
    invoke-virtual {v1, v2, p3}, Landroid/webkit/WebViewDatabase;->addCache(Ljava/lang/String;Landroid/webkit/CacheManager$CacheResult;)V
