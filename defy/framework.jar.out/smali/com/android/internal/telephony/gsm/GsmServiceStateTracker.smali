...
.field roamGrouper:Lcom/android/internal/telephony/gsm/RoamStatusHandler;
...
.method public constructor <init>(Lcom/android/internal/telephony/gsm/GSMPhone;)V
    ...
    iput v6, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->oldGprsState:I

    iput v6, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->networkType:I

    iput v6, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->newNetworkType:I
    ...
    iput-object v3, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->gsmForUnknownMccRegistrants:Landroid/os/RegistrantList;
    ...
    iput-boolean v6, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->curExtraNoSpnCondition:Z

    iput v7, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->curRegState:I

    iput-boolean v6, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mIsVoiceDataOnlyNotificationEnabled:Z

    iput-boolean v6, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->isCurrentMccUnknown:Z
    ...
    new-instance v3, Lcom/android/internal/telephony/gsm/RoamStatusHandler;

    invoke-direct {v3}, Lcom/android/internal/telephony/gsm/RoamStatusHandler;-><init>()V

    iput-object v3, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->roamGrouper:Lcom/android/internal/telephony/gsm/RoamStatusHandler;
    ...
    invoke-direct {v3, p1}, Lcom/motorola/android/telephony/SUPForAssistedDialing;-><init>(Lcom/android/internal/telephony/Phone;)V
    ...
    invoke-interface {v3, p0, v7, v5}, Lcom/android/internal/telephony/CommandsInterface;->registerForRadioStateChanged(Landroid/os/Handler;ILjava/lang/Object;)V

    iget-object v3, p0, Lcom/android/internal/telephony/ServiceStateTracker;->cm:Lcom/android/internal/telephony/CommandsInterface;

    const/4 v4, 0x2

    invoke-interface {v3, p0, v4, v5}, Lcom/android/internal/telephony/CommandsInterface;->registerForNetworkStateChanged(Landroid/os/Handler;ILjava/lang/Object;)V

    iget-object v3, p0, Lcom/android/internal/telephony/ServiceStateTracker;->cm:Lcom/android/internal/telephony/CommandsInterface;

    const/16 v4, 0xb

    invoke-interface {v3, p0, v4, v5}, Lcom/android/internal/telephony/CommandsInterface;->setOnNITZTime(Landroid/os/Handler;ILjava/lang/Object;)V

    iget-object v3, p0, Lcom/android/internal/telephony/ServiceStateTracker;->cm:Lcom/android/internal/telephony/CommandsInterface;

    const/16 v4, 0xc

    invoke-interface {v3, p0, v4, v5}, Lcom/android/internal/telephony/CommandsInterface;->setOnSignalStrengthUpdate(Landroid/os/Handler;ILjava/lang/Object;)V

    iget-object v3, p0, Lcom/android/internal/telephony/ServiceStateTracker;->cm:Lcom/android/internal/telephony/CommandsInterface;

    const/16 v4, 0x17

    invoke-interface {v3, p0, v4, v5}, Lcom/android/internal/telephony/CommandsInterface;->setOnRestrictedStateChanged(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    const-string v4, "rat_signal_strength_raw"
    ...
    iput v3, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->oem_signal:I
...
.method public constructor <init>(ZZLcom/android/internal/telephony/gsm/GSMPhone;)V
    ...
    iput v3, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->oldGprsState:I
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->gprsAttachedRegistrants:Landroid/os/RegistrantList;

    new-instance v1, Landroid/os/RegistrantList;

    invoke-direct {v1}, Landroid/os/RegistrantList;-><init>()V

    iput-object v1, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->gprsDetachedRegistrants:Landroid/os/RegistrantList;

    new-instance v1, Landroid/os/RegistrantList;

    invoke-direct {v1}, Landroid/os/RegistrantList;-><init>()V

    iput-object v1, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->psRestrictEnabledRegistrants:Landroid/os/RegistrantList;

    new-instance v1, Landroid/os/RegistrantList;

    invoke-direct {v1}, Landroid/os/RegistrantList;-><init>()V

    iput-object v1, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->psRestrictDisabledRegistrants:Landroid/os/RegistrantList;

    new-instance v1, Landroid/os/RegistrantList;

    invoke-direct {v1}, Landroid/os/RegistrantList;-><init>()V

    iput-object v1, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->gsmForUnknownMccRegistrants:Landroid/os/RegistrantList;
    ...
    iput-object v2, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->curSpn:Ljava/lang/String;
    ...
    iput-boolean v3, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->curExtraNoSpnCondition:Z

    iput v4, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->curRegState:I

    iput-boolean v3, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mIsVoiceDataOnlyNotificationEnabled:Z

    iput-boolean v3, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->isCurrentMccUnknown:Z

    new-instance v1, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker$1;

    invoke-direct {v1, p0}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker$1;-><init>(Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;)V
    ...
    new-instance v1, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker$2;

    new-instance v2, Landroid/os/Handler;

    invoke-direct {v2}, Landroid/os/Handler;-><init>()V

    invoke-direct {v1, p0, v2}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker$2;-><init>(Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;Landroid/os/Handler;)V

    iput-object v1, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mAutoTimeObserver:Landroid/database/ContentObserver;

    if-nez p1, :cond_0

    const-string v1, "GSM"

    const-string v2, "GsmServiceStateTracker, this should be called."
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->cellLoc:Landroid/telephony/gsm/GsmCellLocation;

    new-instance v1, Landroid/telephony/gsm/GsmCellLocation;

    invoke-direct {v1}, Landroid/telephony/gsm/GsmCellLocation;-><init>()V

    iput-object v1, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->newCellLoc:Landroid/telephony/gsm/GsmCellLocation;
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->supForIAD:Lcom/motorola/android/telephony/SUPForAssistedDialing;

    invoke-virtual {p3}, Lcom/android/internal/telephony/gsm/GSMPhone;->getContext()Landroid/content/Context;
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mWakeLock:Landroid/os/PowerManager$WakeLock;

    const-string v1, "ro.mot.FTR.NSUI"

    invoke-static {v1, v3}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v1

    iput-boolean v1, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->isFtrNsuiEnabled:Z
    ...
    iput-boolean v4, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mIsSwitchedToCdma:Z
...
.method private handleRejectCode([Ljava/lang/String;)V
    ...
    iget-boolean v2, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->isFtrNsuiEnabled:Z
...
.method private isRoamingBetweenOperators(ZLandroid/telephony/ServiceState;)Z
    ...
    .prologue
    const-string v12, "gsm.sim.operator.alpha"
    ...
    :goto_2
    iget-object v12, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->roamGrouper:Lcom/android/internal/telephony/gsm/RoamStatusHandler;

    invoke-virtual {v12, v9}, Lcom/android/internal/telephony/gsm/RoamStatusHandler;->setGrouper(Ljava/lang/String;)V

    iget-object v12, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->roamGrouper:Lcom/android/internal/telephony/gsm/RoamStatusHandler;

    invoke-virtual {v12, v7}, Lcom/android/internal/telephony/gsm/RoamStatusHandler;->isSameGroup(Ljava/lang/String;)Z

    move-result v8

    .local v8, sameGroup:Z
    if-eqz p1, :cond_4
    ...
    :goto_3
    const-string v12, "ro.mot.nat_roaming_enable"
    ...
    .restart local v8       #sameGroup:Z
    .restart local v9       #simNumeric:Ljava/lang/String;
    .restart local v11       #validMcc:Z
    :cond_4
    const/4 v12, 0x0
...
.method private onSignalStrengthResult(Landroid/os/AsyncResult;)V
    ...
    iget v1, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->oem_signal:I
    ...
    invoke-virtual {v1, v12, v3}, Lcom/android/internal/telephony/gsm/GsmOemServiceStateTracker;->getSignalStrength(Landroid/telephony/SignalStrength;Landroid/telephony/SignalStrength;)V
...
.method private pollStateDone()V
    ...
    const-string v35, "autoreg | hasRegistered = "
    ...
    const-string v35, "autoreg | operatorNumeric = "
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v16, "Ignore GSM msgs since GSM phone is inactive"
    ...
    iget-object v15, v15, Lcom/android/internal/telephony/gsm/GSMPhone;->mEonsHandler:Lcom/android/internal/telephony/gsm/EonsHandler;
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/android/internal/telephony/gsm/EonsHandler;->setEonsLoadedRegistrant(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    const-string v16, "gsm.operator.alpha"
    ...
    invoke-virtual/range {v15 .. v17}, Lcom/android/internal/telephony/gsm/GSMPhone;->setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
...
.method protected handlePollStateResult(ILandroid/os/AsyncResult;)V
    ...
    iput v0, v1, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->curRegState:I
    ...
    iput v0, v1, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->oldGprsState:I
    ...
    const-string v17, "android.intent.action.ACTION_CHANGE_DATA_SERVICE_SUPPORT"
    ...
    const-string v17, "com.motorola.intent.action.GET_REJECT_CODE"
...
.method public switchToGsm()V
    ...
    iget-boolean v2, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mIsSwitchedToCdma:Z
    ...
    :cond_0
    iput-boolean v6, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mIsSwitchedToCdma:Z
    ...
    invoke-interface {v2, p0, v3, v4}, Lcom/android/internal/telephony/CommandsInterface;->setOnRestrictedStateChanged(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method protected updateSpnDisplay()V
    ...
    const-string v8, " updateSpnDisplay, DISPLAY No Service"
    ...
    sget-object v9, Lcom/android/internal/telephony/IccCard$State;->ERROR:Lcom/android/internal/telephony/IccCard$State;
    ...
    iget-boolean v8, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->curExtraNoSpnCondition:Z
    ...
    iget-boolean v8, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->isFtrNsuiEnabled:Z
    ...
    const-string v9, "broadcast spn update - ss state:"
    ...
    const-string v8, " updateSpnDisplay, No Service"
